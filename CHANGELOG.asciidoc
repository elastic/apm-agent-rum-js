...
[float]
===== Features
* Make server prefix URL used to make requests to the APM Server configurable: {issue}1078[#1078]
* Expose Transaction, Span, TransactionOptions and SpanOptions types definition: {issue}1045[#1045] and {issue}995[#995]
* Set to empty string span destination deprecated fields: {issue}1098[#1098]
