...
NOTE: Please download the latest version of JavaScript agent from `https://github.com/elastic/apm-agent-js-base/releases/latest` or
`https://unpkg.com/elastic-apm-js-base/dist/bundles/elastic-apm-js-base.umd.min.js` and host the file in your Server/CDN before deploying to production.
