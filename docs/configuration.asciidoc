...
This option is an array of strings or regexes and determines which origins should be monitored as part of distributed tracing.
...
Please note that this list testing the origin part of the url (other parts of the url are ignored), each item in the array should be a valid url or a regex to test the origin part.
