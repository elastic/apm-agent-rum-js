...
pipeline {
  ...
  parameters {
    ...
    string(name: 'stack_version', defaultValue: "8.6.2", description: "What's the Stack Version to be used for the load testing?")
  }
  stages {
    stage('Initializing'){
          ...
          matrix {
            axes {
              axis {
                ...
                // .ci/bump-elastic-stack.yml
                values '8.0.0-SNAPSHOT', "8.6.2"
              }
              axis {
                name 'SCOPE'
                values (
